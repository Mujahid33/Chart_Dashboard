      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col align-self-center mt-5">
            <form action="<?= site_url('maincontroller/proses_input_jk'); ?>" method="post">
                    ...
                    <div class="card-body">
                      <table>
                        <tr>
                          ...
                          <td><input class="form-control mx-sm-3 mb-3" type="number" name="jl" autofocus></td>

                        </tr>
                        <tr>
                          <td>Jumlah Perempuan</td>
                          <td><input class="form-control mx-sm-3 mb-3" type="number" name="jp"></td>
                        </tr>
                        <tr>
                          <td>Tahun</td>
