      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col align-self-center mt-5">
            <form action="<?= site_url('maincontroller/proses_input_pl'); ?>" method="post">
                  ...
                  <div class="card" style="width: 28rem;">
                    <div class="card-body">
                      <table>
                        <tr>
                          <td>Pertanian</td>
                          <td><input class="form-control mx-sm-3 mb-3" type="number" name="p" autofocus></td>

                        </tr>
                        <tr>
                          <td>Non Pertanian</td>
                          <td><input class="form-control mx-sm-3 mb-3" type="number" name="np"></td>
                        </tr>
                        <tr>
                          <td>Tahun</td>
