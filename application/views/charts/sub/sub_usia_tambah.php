      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col align-self-center mt-5">
            <form action="<?= site_url('maincontroller/proses_input_usia'); ?>" method="post">
                ...
                <center>
                  <div class="card" style="width: 28rem;">
                    <div class="card-body">
                      <table>
                        <tr>
                          <td>Penduduk 0-14 Tahun</td>
                          <td><input class="form-control mx-sm-3 mb-3" type="number" name="anak" autofocus></td>

                        </tr>
                        <tr>
                          <td>Penduduk 15-64 Tahun</td>
                          <td><input class="form-control mx-sm-3 mb-3" type="number" name="dewasa"></td>
                        </tr>

                        <tr>
                          <td>Penduduk 65 Tahun ke Atas</td>
                          <td><input class="form-control mx-sm-3 mb-3" type="number" name="tua"></td>
                        </tr>
